...
public class HypothesisTest {
	...
	public static void setUpBeforeClass() throws Exception {
		/*
		 * Reads data about hypotheses and their isMoreGeneralThan result from file
		 * in order to test later whether the isMoreGeneralThan method produces the
		 * same result.
		 * Each line of the file, from which the data is read has the following structure:
		 * 1st feature value of 1st hypothesis, 2nd feature value of 1st hypothesis,
		 * 3rd feature value of 1st hypothesis, 1st feature value of 2nd hypothesis,
		 * 2nd feature value of 2nd hypothesis, 3rd feature value of 2nd hypothesis,
		 ...
		 * possible values:
		 * feature 1 can have values A and B,
		 * feature 2 can have values C and D,
		 * feature 3 can have values E and F
		 * */
