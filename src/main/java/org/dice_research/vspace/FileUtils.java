...
/** 
* Here, we are trying to find the latest file in a directory 
* as there can be multiple files of same extension,
...
public class FileUtils {
  ...
  /**
  * Method will move to file to archive folder 
  * and will delete it from current folder
  */

  public static boolean filemovetoanotherfolder(String sourcefolder,
